...
set "AMENT_ENVIRONMENT_HOOKS[move_from_keys]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[move_from_keys] "%AMENT_CURRENT_PREFIX%\share\move_from_keys\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[move_from_keys] "%AMENT_CURRENT_PREFIX%\share\move_from_keys\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[move_from_keys]:;=";"%") do (
    call:call_file %%f
  )
