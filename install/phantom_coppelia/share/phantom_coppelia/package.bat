...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\phantom_coppelia\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/phantom_coppelia/local_setup.bat"
