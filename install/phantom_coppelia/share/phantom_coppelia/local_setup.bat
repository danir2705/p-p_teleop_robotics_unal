...
set "AMENT_ENVIRONMENT_HOOKS[phantom_coppelia]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[phantom_coppelia] "%AMENT_CURRENT_PREFIX%\share\phantom_coppelia\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[phantom_coppelia] "%AMENT_CURRENT_PREFIX%\share\phantom_coppelia\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[phantom_coppelia]:;=";"%") do (
    call:call_file %%f
  )
