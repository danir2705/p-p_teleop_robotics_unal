...
set "AMENT_ENVIRONMENT_HOOKS[phantom_description]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[phantom_description] "%AMENT_CURRENT_PREFIX%\share\phantom_description\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[phantom_description] "%AMENT_CURRENT_PREFIX%\share\phantom_description\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[phantom_description]:;=";"%") do (
    call:call_file %%f
  )
