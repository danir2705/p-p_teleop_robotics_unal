...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joy_controller\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joy_controller\hook\ament_prefix_path.bat"
