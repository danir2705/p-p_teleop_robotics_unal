...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\move_from_keys\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\move_from_keys\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\move_from_keys\hook\ament_prefix_path.bat"
