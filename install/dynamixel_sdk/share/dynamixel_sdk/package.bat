...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\dynamixel_sdk\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\dynamixel_sdk\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\dynamixel_sdk\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/dynamixel_sdk/local_setup.bat"
