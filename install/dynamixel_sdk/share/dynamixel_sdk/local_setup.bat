...
set "AMENT_ENVIRONMENT_HOOKS[dynamixel_sdk]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dynamixel_sdk] "%AMENT_CURRENT_PREFIX%\share\dynamixel_sdk\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[dynamixel_sdk] "%AMENT_CURRENT_PREFIX%\share\dynamixel_sdk\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[dynamixel_sdk]:;=";"%") do (
    call:call_file %%f
  )
