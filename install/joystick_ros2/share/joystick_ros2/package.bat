...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joystick_ros2\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\joystick_ros2\hook\ament_prefix_path.bat"
